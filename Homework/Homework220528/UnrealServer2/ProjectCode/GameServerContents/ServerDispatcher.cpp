...
{																																													
	...
	Dis.AddHandler(static_cast<uint32_t>(MessageId::Big), std::bind(&OnMessageProcess<ThreadHandlerBigMessage, BigMessage>, std::placeholders::_1, std::placeholders::_2));	
	Dis.AddHandler(static_cast<uint32_t>(MessageId::Attack), std::bind(&OnMessageProcess<ThreadHandlerAttackMessage, AttackMessage>, std::placeholders::_1, std::placeholders::_2));	
