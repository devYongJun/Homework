	...
	: ClientUniqueId_(0)
{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> Particle(TEXT("/Game/ServerClient/Resources/Particle/Explosion.Explosion"));
...
void APlayGameMode::ExplosionParticle(FVector _Location)
{
	UGameplayStatics::SpawnEmitterAtLocation(GetWorld(), Explosion, _Location);
}
