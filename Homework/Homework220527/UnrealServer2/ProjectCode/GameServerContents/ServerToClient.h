...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(ResultCharacter) + DataSizeCheck(Code);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(Code) + DataSizeCheck(NickName);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(ObjectIndex) + DataSizeCheck(ThreadIndex) + DataSizeCheck(SectionIndex) + DataSizeCheck(MoveLevel);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(Code) + DataSizeCheck(ObjectIndex);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(Code) + DataSizeCheck(UDPPort) + DataSizeCheck(ObjectIndex) + DataSizeCheck(ThreadIndex) + DataSizeCheck(SectionIndex) + DataSizeCheck(MoveLevel);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(ObjectID);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(Characters);
    }                                                           
...
public:                                                         
    ...
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(TopUserName) + DataSizeCheck(TopUserScore) + DataSizeCheck(MyUserName) + DataSizeCheck(MyUserScore);
    }                                                           
...
class AttackResultMessage : public GameServerMessage                    
{                                                               
public:                                                         
	uint64_t ObjectIndex;
	uint64_t ThreadIndex;
...
public:                                                         
    AttackResultMessage()                                               
        : GameServerMessage(static_cast<uint32_t>(MessageId::AttackResult))                    
        , ObjectIndex()
        , ThreadIndex()
        , SectionIndex()
        , Hp()
    ...
    virtual ~AttackResultMessage() {}                                   
                                                                
    virtual int SizeCheck()                                     
    {                                                           
		return 8 + DataSizeCheck(ObjectIndex) + DataSizeCheck(ThreadIndex) + DataSizeCheck(SectionIndex) + DataSizeCheck(Hp);
    }                                                           
